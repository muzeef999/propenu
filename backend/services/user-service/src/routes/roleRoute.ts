...
import { createRole, deleteRole, getAllRoles, getAssignableRoles, getPermissionCatalog, getRoleById, getTeamDirectoryRoles, updateRole, updateRolePermissions, updateRoleStatus } from "../controller/roleController";
...
roleRoute.patch("/:id", authMiddleware, requirePermission("role:update"), updateRole);
