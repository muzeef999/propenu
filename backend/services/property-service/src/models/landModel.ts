...
const LandSchema = new Schema<ILand>(
  {
    ...BaseFields,
    plotArea: Number,
    plotAreaUnit: { type: String, enum: ['sqft', 'sqmt', 'acre', 'guntha', 'kanal', 'hectare'] },
    roadWidthFt: Number,
...
export const LandPlot: Model<ILand> =
  (mongoose.models && (mongoose.models as any)['LandPlot']) || mongoose.model<ILand>('LandPlot', LandSchema);
