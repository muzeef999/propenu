...
const allowed = (process.env.ALLOWED_ORIGINS || "http://localhost:3000, http://localhost:3001, https://propenu.vercel.app, https://propenu.netlify.app, http://localhost:8081, http://localhost:8082", "https://propenu.com")
  .split(",")
