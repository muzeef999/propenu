          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
              ...
              <div className="border-b border-gray-200 pb-8">
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  ...
                  <p>
                    ...
                    &amp; Conditions and our Privacy Policy. Please read
                    carefully.
                  </p>
                  <p>
                    These Terms &amp; Conditions ("Terms") govern your access to
                    and use of the Propenu website, mobile application, and all
                    related features, tools, and services (collectively referred
                    to as the "Platform" or "Services").
                  </p>
                  <p>
                    Propenu ("we", "our", "us") provides a technology-driven
                    real estate platform that enables users to list, search,
                    discover, and enquire about properties, and to communicate
                    with other users including buyers, sellers, owners, agents,
                    builders, and developers.
                  </p>
                  <p>
                    By accessing, browsing, registering on, or using the Propenu
                    Platform or Services, you agree to be bound by these Terms,
                    along with our Privacy Policy and any other applicable
                    policies. If you do not agree to these Terms, you should not
                    access or use the Platform or Services.
                  </p>
                  <p>
                    These Terms apply to all users of the Platform, including
                    but not limited to owners, buyers, sellers, landlords,
                    tenants, agents, builders, developers, advertisers, and
                    general website visitors.
                  </p>
                  <p className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
                    Propenu reserves the right to modify or update these Terms
                    at any time. Changes will be effective upon posting on the
                    Platform, and continued use of the Services constitutes
              ...
              <div className="space-y-3 text-gray-700">
                <p>
                  By accessing or using the Propenu Platform or Services, you
                ...
                <p>
                  Your continued use of Propenu after any updates or changes to
              ...
              <div className="border-t border-gray-200 pt-8">
                ...
                <div className="space-y-3 text-gray-700">
                  <p>
                    Some features of the Propenu Platform require users to
                    create an account. Users must provide accurate, current, and
                    complete information during registration and keep their
                    account details updated.
                  </p>
                  <p>
                    You are responsible for maintaining the confidentiality of
                    your login credentials and for all activities carried out
                    under your account. Users may choose to deactivate their
                    account at any time.
                  </p>
                  <p>
                    Propenu is not responsible for any loss or damage resulting
                    from unauthorized access to your account due to your failure
                    to secure your credentials.
                  </p>
                  <p className="bg-red-50 border-l-4 border-red-400 p-4 rounded">
                    Propenu reserves the right to suspend, restrict, or
                    terminate accounts that violate these Terms, applicable
                    laws, or engage in fraudulent, misleading, or harmful
                    activities.
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-3 text-gray-700">
                  ...
                  <ul className="space-y-2 ml-4">
                    <li className="flex gap-2">
                      ...
                      <span>
                        Users may create, upload, and manage property listings
                        on the Propenu Platform
                      </span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-[#D4AF37] font-bold">•</span>
                      <span>
                        All listings must contain accurate, complete, lawful,
                    ...
                    <li className="flex gap-2">
                      <span className="text-[#D4AF37] font-bold">•</span>
                      <span>
                        Propenu follows a KYC-based verification process and
                        applies verification checks to reduce spam and fraud
                      </span>
                    </li>
                  </ul>
                  <p className="pt-2">
                  ...
                  <p>
                    ...
                    third-party rights, including ownership, contractual, or
                    intellectual property rights.
                  </p>
                  <p>
                    Propenu is not a party to any transaction between users and
                    does not guarantee the outcome, completion, or quality of
                    any property deal arising from listings on the Platform.
                  </p>

                  <p className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
                    Propenu may review, approve, modify, restrict, or remove any
                    listing or content that violates these Terms, applicable
                    laws, or platform policies, or that is misleading,
                    incomplete, or harmful.
                  </p>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 pt-8">
                ...
                <div className="space-y-3 text-gray-700">
                  <p>
                    Propenu may display advertisements, promoted content,
                    sponsored listings, banners, or featured placements across
                    the Platform.
                  </p>
                  <p>
                    Sponsored or promoted listings may receive higher
                    visibility, such as priority placement in search results,
                    locality pages, or homepage sections.
                  </p>
                  <p>
                    Advertisers may include owners, agents, builders,
                    developers, banks, or other real estate–related service
                    providers.
                  </p>
                  <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded space-y-2">
                    <p className="font-semibold">Important Notice:</p>
                    <p>
                      Participation in paid promotions or sponsored placements
                      does not guarantee leads, enquiries, or transaction
                      outcomes.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      Propenu’s business model and agree to the display of such
              ...
              <div className="border-t border-gray-200 pt-8">
                ...
                <div className="space-y-3 text-gray-700">
                  <p>
                    All content, software, design, logos, trademarks, and
                    materials available on the Propenu Platform are owned by or
                    licensed to Propenu, unless stated otherwise.
                  </p>
                  <p>
                    Users are granted a limited, non-exclusive, non-transferable
                    right to access and use the Platform for personal or
                  ...
                  <div className="bg-red-50 border-l-4 border-red-400 p-4 rounded">
                    ...
                    <ul className="space-y-1 ml-4 text-sm">
                      <li>
                        ...
                        Platform without prior written permission from Propenu.
                      </li>
                      <li>
                  ...
                  <p>
                    Any feedback, suggestions, or ideas shared with Propenu may
                    be used by Propenu without obligation or compensation to the
                    user.
                  </p>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 pt-8">
                <SectionHeader
                  id="leads"
                  title="6. Lead Management & Analytics"
                />
                <div className="space-y-3 text-gray-700">
                  <p>
                    Propenu provides tools that allow users to receive, view,
                    manage, and respond to enquiries or leads generated through
                    the Platform.
                  </p>
                  <p>
                    Analytics and insights may be provided to help users
                    understand listing performance, engagement, and response
                    activity.
                  </p>
                  <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
                    ...
                    <ul className="space-y-1 ml-4 text-sm">
                      ...
                      <li>
                        • Users must not share, sell, distribute, or misuse lead
                        data or analytics information without proper consent or
                        legal basis.
                      </li>
                      <li>
                        • Decisions made based on leads or analytics are the
                        sole responsibility of the user
                      </li>
                    </ul>
                  </div>
                  <p>
                    Propenu does not guarantee the volume of leads, user intent,
                    or conversion outcomes, and analytics data reflects user
                    interactions and trends, not guaranteed results.
                  </p>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 pt-8">
                ...
                <div className="space-y-3 text-gray-700">
                  ...
                  <p>
                    All applicable fees, pricing, and payment terms will be
                  ...
                  <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded space-y-2">
                    ...
                    <ul className="space-y-1 ml-4 text-sm">
                      ...
                      <li>
                        • Users agree to pay all fees associated with the
                        services they choose to use.
                      </li>
                      <li>
                        • A subscription is valid for one property only and is
                        non-transferable to another property or another user;
                        once the listed property is sold or rented, the
                        remaining subscription period cannot be reused and a new
                        subscription will be required for new property.
                      </li>
                      <li>
                        • Failure to complete payment may result in restricted
                        access, suspension, or termination of paid features or
                        services.
                      </li>
                    </ul>
                  </div>
                  <p>
                    Propenu reserves the right to modify pricing, subscription
                    plans, or payment structures, with prior notice where
                    applicable.
                  </p>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 pt-8">
                ...
                <div className="space-y-3 text-gray-700">
                  <p>
                    Propenu respects user privacy and is committed to protecting
                    personal data.
                  </p>
                  <p>
                    The collection, use, storage, and processing of personal
                    information is governed by Propenu's Privacy Policy.
                  </p>
                  <p>
                    By using the Propenu Platform, users consent to the handling
                    of their information in accordance with the Privacy Policy.
                  </p>
                  <p className="bg-green-50 border-l-4 border-green-400 p-4 rounded">
                    Users are encouraged to review the Privacy Policy to
                    understand how their data is managed and protected.
                  </p>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 pt-8">
                ...
                <div className="space-y-3 text-gray-700">
                  <div className="bg-red-50 border-l-4 border-red-400 p-4 rounded space-y-2">
                    ...
                    <p>
                      Propenu provides the Platform and Services on an "as is"
                      and "as available" basis without warranties of any kind.
                    </p>
                    <p>
                      To the maximum extent permitted by law, Propenu shall not
                      be liable for any direct, indirect, incidental,
                      consequential, or special damages arising out of the use
                  ...
                  <p>
                    Propenu is not responsible for any losses, damages, delays,
                    or disputes arising from interactions or transactions
                    between users.
                  </p>
                  <p>
              ...
              <div className="border-t border-gray-200 pt-8">
                ...
                <div className="space-y-3 text-gray-700">
                  <p>
                    Propenu may suspend or terminate a user's account if the
                    user violates these Terms, applicable laws, or platform
                    policies.
                  </p>
                  <p>
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
                    <p>
                      Users may deactivate their account at any time, and
                      Propenu may terminate accounts for policy violations; in
                      either case, any obligations or responsibilities that
                      arose while the account was active will continue to apply.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 pt-8">
                <SectionHeader
                  id="governing"
                  title="12. Governing Law or Jurisdiction"
                />
                <div className="space-y-3 text-gray-700">
                  <p>
                  ...
                  <div className="bg-purple-50 border-l-4 border-purple-400 p-4 rounded">
                    ...
                    <p>
                      All disputes, claims, or legal proceedings arising out of
                      or relating to the use of the Propenu Platform or Services
                      shall be subject to the exclusive jurisdiction of the
                      courts located in Hyderabad, Telangana, India.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 pt-8">
                ...
                <div className="space-y-3 text-gray-700">
                  <p>
                    Propenu may update or modify these Terms & Conditions from
                    time to time.
                  </p>
                  <p>
                    Any changes will be effective once posted on the Platform
                    with a revised effective date.
                  </p>
                  <div className="bg-green-50 border-l-4 border-green-400 p-4 rounded space-y-2">
                    <p>
                      Continued use of the Propenu Platform after such changes
                      constitutes acceptance of the updated Terms.
                    </p>
                    <p>
                      {" "}
                      Users are encouraged to review these Terms periodically to
                      stay informed.
                    </p>
                  </div>
                </div>
