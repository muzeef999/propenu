    ...
    return (
      <div className="grid w-full grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {items.map((project: any) => (
          <div
            key={project._id}
            className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-shadow hover:shadow-lg cursor-pointer"
          >
            {/* IMAGE */}
            ...
            <div className="space-y-3 p-4">
              ...
              <div className="flex items-start gap-1.5 text-[14px] text-slate-600">
                <MdOutlineLocationOn className=" text-[18px] text-slate-500" />
