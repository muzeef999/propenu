...
interface RelatedCommercialCarouselProps {
  projects: ICommercial[];
}

const RelatedCommercialCarousel = ({
  projects,
}: RelatedCommercialCarouselProps) => {
    ...
    <div className="relative">
      ...
      >
        {projects.map((relatedProject) => (
          ...
          >
            <CommercialCard p={relatedProject} vertical={true} />
          </div>
        ))}
      </div>
      <button
...
export default RelatedCommercialCarousel;