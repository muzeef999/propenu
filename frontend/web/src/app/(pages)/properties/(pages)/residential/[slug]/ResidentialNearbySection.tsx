...
import type { NearbyPlace } from "@/types/residential";
...
export default function ResidentialNearbySection({
  projectLocation,
  projectName,
  nearbyLandmarks,
}: Props) {
            ...
            nearbyLandmarks.map((place, index) => {
              ...
              return (
                <li
                  ...
                  className={`w-[280px] shrink-0 cursor-pointer rounded-md p-3 transition sm:w-[320px] ${isActive
